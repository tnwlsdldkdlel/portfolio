...
**🚫 절대 자동 커밋 금지: 깃 커밋과 푸시는 사용자가 명시적으로 요청할 때만 수행합니다.**

#### 커밋/푸시 금지 상황
- ❌ 작업 완료 후 자동으로 커밋하지 않음
- ❌ 빌드/린트 테스트 통과 후 자동 커밋하지 않음
- ❌ Phase 완료 후 자동 커밋하지 않음
- ❌ 사용자가 "커밋해줘", "푸시해줘", "깃에 올려줘" 등 명시적으로 요청하지 않은 경우

#### 커밋/푸시 허용 상황
- ✅ 사용자가 "깃에 커밋하고 푸시해줘"라고 명시적으로 요청한 경우
- ✅ 사용자가 "커밋해줘"라고 명시적으로 요청한 경우
- ✅ 사용자가 "푸시해줘"라고 명시적으로 요청한 경우

**기본 원칙: 사용자가 명시적으로 요청하지 않으면 절대 커밋/푸시하지 않습니다.**
